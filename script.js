...
const button = document.getElementById('toggle_checkbox');
...
function sendEmail() {
  ...
  var mailtoUrl = "mailto:adsvenchar@gmail.com?subject=" + encodeURIComponent(subject) + "&body=" + encodeURIComponent(message);
